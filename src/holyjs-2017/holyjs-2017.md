...
Note: Сейчас большинство js-фреймворков - это обычно одно ядро, вокруг которого накручено много всего: react занимается и view и состояние там есть, и логика вокруг него накручена. Аналогично в vue, glimmer и многих других похожих на реакт.
...
- DI
- Собираем в метафреймвок

Note: Однако, если посмотреть, как развивались другие языки, например, java, php, то в итоге наблюдается тенденция, когда множество мелких библиотек, связанных слабо, через интерфейсы, собираются в фреймворк посредством инверсии зависимостей. Даже говорят мета-фреймворк или BYO (BUILD YOUR OWN). Например: Spring в Java, Symfony в Php. У нас, на фронтенде, наиболее близок к этой концепции - angular2.
